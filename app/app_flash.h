 ...
 *   0x01C   4     pos_kp    (float)
 *   0x020   4     steer_kp  (float)
 *   0x024   4     steer_kd  (float)
 *   0x028   4     heading_kp(float)
 *   0x02C   4     target_speed(float)
 *   0x030   4     imu_yaw_offset(float)
 *   0x034   4     imu_roll_offset(float)
 *   0x038   2     gray_threshold(uint16_t)
 *   0x03A   1     buzzer_enabled(uint8_t)
 *   0x03C   16    lap_times[4](uint32_t ms)
 *   0x04C   4     checksum (XOR)
 */
